        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/70">ECOLOPACK Co., Ltd.</p>
              </div>
            </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              ...
              <Link href="/company" className="block text-white/70 hover:text-white transition-colors">
                会社情報
              </Link>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link href="/products/blan-form-top" className="block text-white/70 hover:text-white transition-colors">
                ブランフォームトップ
              </Link>
              <Link href="/products/blan-form" className="block text-white/70 hover:text-white transition-colors">
                ブランフォーム
              </Link>
              <Link href="/products/blan-form-big" className="block text-white/70 hover:text-white transition-colors">
                ブランフォームBIG
              </Link>
              <Link href="/products/ecolopat" className="block text-white/70 hover:text-white transition-colors">
                エコロパット
              </Link>
              <Link href="/products/blan-form-green" className="block text-white/70 hover:text-white transition-colors">
                ブランフォームグリーン
              </Link>
            </nav>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20">
          <div className="flex flex-wrap items-center justify-center gap-8 mb-8">
            <div className="text-center">
              ...
              <p className="text-xs text-white/70">品質マネジメント</p>
            </div>
            <div className="text-center">
              <div className="bg-white/10 rounded-lg p-4 mb-2">
                <span className="text-2xl font-bold">ISO 14001</span>
              </div>
              <p className="text-xs text-white/70">環境マネジメント</p>
            </div>
            <div className="text-center">
              <div className="bg-white/10 rounded-lg p-4 mb-2">
                <span className="text-xl font-bold">エコマーク</span>
              </div>
              <p className="text-xs text-white/70">認定取得</p>
            </div>
          </div>
        </div>
