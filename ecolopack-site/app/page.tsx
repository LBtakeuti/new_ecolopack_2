        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="tel:0729400323"
                className="inline-flex items-center justify-center bg-white text-primary border-2 border-primary px-8 py-4 rounded-lg font-bold hover:border-primary-dark hover:text-primary-dark hover:scale-105 transition-all duration-300 text-lg shadow-lg hover:shadow-2xl transform hover:-translate-y-2 w-full sm:w-auto"
              >
